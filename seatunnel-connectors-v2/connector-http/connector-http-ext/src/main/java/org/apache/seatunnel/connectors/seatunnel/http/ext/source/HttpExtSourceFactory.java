...
public class HttpExtSourceFactory extends HttpSourceFactory {
    @Override
    public String factoryIdentifier() {
        return HttpExtSource.PLUGIN_NAME;
    }

    @Override
    public <T, SplitT extends SourceSplit, StateT extends Serializable>
            TableSource<T, SplitT, StateT> createSource(TableSourceFactoryContext context) {
        return () -> (SeaTunnelSource<T, SplitT, StateT>) new HttpExtSource(context.getOptions());
    }
